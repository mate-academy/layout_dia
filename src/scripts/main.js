...
const listMenuCloser = document.querySelector('.nav__list');
const footerListMenuCloser = document.querySelector('.nav__list--footer');
...
listMenuCloser.addEventListener('click', function() {
  body.classList.remove('page__body--overflow-hidden');
});

footerListMenuCloser.addEventListener('click', function() {
  body.classList.remove('page__body--overflow-hidden');
});
