...
5. In the PROCESS section add a hover effect to cards (for example, let them increase in size a little) - OK
6. In the Testimonials and Our expertise section add hover effects for each review - OK
